...
Thread::Thread(char *threadName)
{
    ...
    // Modified - Initialized variables
    startTime = 0;
    totalTime = 0;
}
...
void Thread::Yield()
{
    ...
    cout << endl
         << "Yielding thread: " << kernel->currentThread->getName() << " at " << kernel->stats->totalTicks << endl;
    cout << "\nCurrent Tree Structure: " << endl;
    cout << "Thread | Runtime | Node Color" << endl;
    cout << "------------------------------" << endl;
    ASSERT(this == kernel->currentThread);
    ...
    if (nextThread != NULL)
    {
        cout << "\nNext thread to run: " << nextThread->getName() << endl
             << endl;
